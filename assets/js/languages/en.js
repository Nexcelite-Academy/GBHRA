...
const en = {
    ...
    home: {
        ...
        eventDate3: "August 16, 2025",
        eventDate4: "August 23, 2025",
        eventDate5: "August 30, 2025",
        pblWorkshop1: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 1",
        pblWorkshop1Desc: "Providing high school students with medical exploration opportunities through PBL courses that simulate real medical scenarios and experience medical school learning methods.",
        pblWorkshop2: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 2", 
    ...
    events: {
        ...
        cards: {
            ...
            3: {
                date: "August 16, 2025",
                title: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 1",
                desc: "Providing high school students with medical exploration opportunities through PBL courses that simulate real medical scenarios and experience medical school learning methods.",
                detailsBtn: "Event Details"
            },
            4: {
                date: "August 23, 2025", 
                title: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 2",
                desc: "Building mentorship networks between medical students and high school students, helping students understand HKU Medical School culture and learning environment.",
                detailsBtn: "Event Details"
            },
            5: {
                date: "August 30, 2025",
                title: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 3", 
                desc: "Developing critical thinking and problem-solving skills through case discussions to cultivate medical thinking patterns.",
                detailsBtn: "Event Details"
            }
        }
    },
    ...
    event: {
        ...
        pblworkshop1: {
            pageTitle: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 1 | Event Details | The Greater Bay Area Healthcare Development and Research Association",
            date: "August 16, 2025",
            title: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 1",
            description: "Providing high school students with medical exploration opportunities through Problem-Based Learning (PBL) courses that simulate real medical scenarios, allowing students to experience medical school learning methods firsthand. The activity helps students explore medicine as a career possibility and sparks their interest in the healthcare industry.",
            overviewTitle: "Event Overview",
            organizer: "Organizer: The Greater Bay Area Healthcare Development and Research Association",
            facilitators: "Venue: The University of Hong Kong Li Ka Shing Faculty of Medicine Discussion Rooms (PBL rooms)",
            honoraryGuest: "Honorary Guest: Professor Chak-sing Lau (Dean of HKU Li Ka Shing Faculty of Medicine, Acting Vice-President of HKU)",
            participants: "Target Audience: High school students interested in medicine or medical school",
            capacity: "Capacity: 15 people (small class teaching)",
            contentTitle: "Workshop Content",
            content1: "Introduction to PBL methodology and theoretical foundations",
            content2: "MedQuest Case Series: Respiratory System Disease Diagnosis and Treatment",
            content3: "Group collaboration and diagnostic reasoning training",
            content4: "Case report preparation and presentation skills",
            content5: "Reflection and learning effectiveness assessment",
            scheduleTitle: "Activity Schedule",
            scheduleHeader: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 1 Activity Arrangement",
            scheduleName: "Activity Name: MedQuest: Prelude – Gateway to Medicine PBL Workshop 1",
            scheduleDate: "Activity Date: August 16, 2025",
            scheduleTime: "Activity Time: 12:00 - 17:00",
            scheduleLocation: "Venue: The University of Hong Kong Li Ka Shing Faculty of Medicine Discussion Rooms (PBL rooms)",
            morningSession: "Activity Schedule",
            morning1: "12:00-13:00 Venue setup (Students may gather at 12:45)",
            morning2: "13:00-13:30 Ice-breaking games (Name chain, Telephone game, Who's the spy)",
            morning3: "13:30-15:30 PBL Case Study (First introduce what PBL is, then gradually guide students to think)",
            morning4: "15:30-16:00 Professor Lau's sharing (Speech, advice for students/PBL, Q&A session)",
            afternoonSession: "",
            afternoon1: "16:00-17:00 Medical student sharing + Q&A",
            afternoon2: "",
            afternoon3: "",
            afternoon4: "",
            afternoon5: "",
            learningOutcomes: "Learning Outcomes",
            outcome1: "Understand the core concepts and applications of PBL methodology",
            outcome2: "Enhance clinical case analysis and diagnostic thinking abilities",
            outcome3: "Strengthen teamwork and communication skills",
            outcome4: "Establish self-directed learning abilities in medical studies",
            photosTitle: "Event Photos",
            backButton: "Back to Events List"
        },
        pblworkshop2: {
            pageTitle: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 2 | Event Details | The Greater Bay Area Healthcare Development and Research Association",
            date: "August 23, 2025",
            title: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 2",
            description: "Building mentorship networks between medical students and high school students through ice-breaking games and medical student sharing & Q&A sessions, promoting interaction between medical students and high school students to establish mentoring relationships. Helping high school students better understand the University of Hong Kong and medical school culture.",
            overviewTitle: "Event Overview",
            organizer: "Organizer: The Greater Bay Area Healthcare Development and Research Association",
            facilitators: "Venue: The University of Hong Kong Li Ka Shing Faculty of Medicine Discussion Rooms (PBL rooms)",
            specialGuest: "Special Guest: Mr. Wong Wai Shing (Chairman of Hong Kong Young Entrepreneurs Association)",
            participants: "Target Audience: High school students interested in medicine or medical school",
            capacity: "Capacity: 15 people (small class teaching)",
            contentTitle: "Workshop Content",
            content1: "Complex case diagnostic thinking and reasoning",
            content2: "Multidisciplinary collaborative case analysis",
            content3: "Clinical decision tree construction and application",
            content4: "Cross-specialty integration discussion",
            content5: "Case solution evaluation and optimization",
            scheduleTitle: "Activity Schedule",
            scheduleHeader: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 2 Activity Arrangement",
            scheduleName: "Activity Name: MedQuest: Prelude – Gateway to Medicine PBL Workshop 2",
            scheduleDate: "Activity Date: August 23, 2025",
            scheduleTime: "Activity Time: 12:00 - 17:00",
            scheduleLocation: "Venue: The University of Hong Kong Li Ka Shing Faculty of Medicine Discussion Rooms (PBL rooms)",
            morningSession: "Activity Schedule",
            morning1: "12:00-13:30 Venue setup (Students may gather at 13:30)",
            morning2: "14:00-14:30 Ice-breaking games (Name chain, Telephone game, Who's the spy)",
            morning3: "14:30-16:30 Case Study (First introduce what PBL is, then gradually guide students to think)",
            morning4: "16:30-17:00 Medical student sharing + Q&A",
            afternoonSession: "",
            afternoon1: "",
            afternoon2: "",
            afternoon3: "",
        ...
        pblworkshop3: {
            pageTitle: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 3 | Event Details | The Greater Bay Area Healthcare Development and Research Association",
            date: "August 30, 2025",
            title: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 3",
            description: "Developing critical thinking and problem-solving skills, students will participate in case discussions under the guidance of medical students, learning to analyze complex medical scenarios and propose solutions, cultivating critical thinking and teamwork abilities.",
            overviewTitle: "Event Overview",
            organizer: "Organizer: The Greater Bay Area Healthcare Development and Research Association",
            facilitators: "Venue: The University of Hong Kong Li Ka Shing Faculty of Medicine Discussion Rooms (PBL rooms)",
            participants: "Target Audience: High school students interested in medicine or medical school",
            capacity: "Capacity: 15 people (small class teaching)",
            contentTitle: "Workshop Content",
            content1: "Comprehensive case simulation and practical exercises",
            content2: "PBL learning outcome integration and application",
            content3: "Comprehensive assessment of clinical practical skills",
            content4: "Personal learning portfolio development",
            content5: "Future learning planning and career development guidance",
            scheduleTitle: "Activity Schedule",
            scheduleHeader: "MedQuest: Prelude – Gateway to Medicine PBL Workshop 3 Activity Arrangement",
            scheduleName: "Activity Name: MedQuest: Prelude – Gateway to Medicine PBL Workshop 3",
            scheduleDate: "Activity Date: August 30, 2025",
            scheduleTime: "Activity Time: 12:00 - 17:00",
            scheduleLocation: "Venue: The University of Hong Kong Li Ka Shing Faculty of Medicine Discussion Rooms (PBL rooms)",
            morningSession: "Activity Schedule",
            morning1: "12:00-13:30 Venue setup (Students may gather at 13:30)",
